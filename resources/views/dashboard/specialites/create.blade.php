@extends('layouts.dashboard', ['title' => 'Ajout d\'une specialites', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-specialites'])
        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body" id="show_create">
                    <h6 class="fw-bold">Informations specialites </h6>
                    <form action="{{ route('specialites.store') }}" method="POST" id="add_type_piece_form"
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-floating">
                                    <input type="text" id="libelle" name="libelle"
                                        ...
                                        value="{{ old('libelle') }}" placeholder="Type de pièce" autocomplete="libelle"
                                        autofocus required>
