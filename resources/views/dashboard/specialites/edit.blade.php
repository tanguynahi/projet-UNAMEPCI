@extends('layouts.dashboard', ['title' => 'Modifier une specialites', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Modifier-specialites'])
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="dropdown morphing scale-left">
                        ...
                        <a href="{{ route('specialites.index') }}" class="btn btn-primary d-inline">Retour</a>
                    </div>
                </div>
                <div class="card-body" id="show_create">
                    <h6 class="fw-bold">Informations de la specialites</h6>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-floating">
                                    <input type="text" id="libelle" name="libelle"
                                        ...
                                        value="{{ old('libelle', $specialite->libelle) }}" placeholder="Type de pièce"
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <textarea name="description" class="form-control no-resize @error('description') is-invalid @enderror" rows="4"
                                    placeholder="Description" autocomplete="description" autofocus>{{ old('description', $specialite->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
