                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10 col-sm-12 col-12">
                        <div class="payment-result-card text-center">
                            ...
                            {{-- Bouton retour --}}
                            <a href="{{ route('mutualistes.index') }}" class="btn-back-custom">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
                                </svg>
                                Retour à la listes des membres
                            </a>
        ...
        if (indexInput && codePInput) {
            ...
            function appelerRoute() {
                if (compteur < 15) {
                    ...
                    const url = "{{ route('adhesionRelance', ['codePaiement' => 'CODE_PLACEHOLDER', 'ind' => 'compteur']) }}"
