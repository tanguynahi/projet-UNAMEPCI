@extends('layouts.dashboard', ['title' => 'Ajout d\'un coprs', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Corps'])
    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body" id="show_create">
                ...
                <form action="{{ route('corps.store') }}" method="POST" id="add_type_corps_form" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating">
                                <input type="text" id="libelle" name="libelle" class="form-control @error('libelle') is-invalid @enderror" value="{{ old('libelle') }}" placeholder="Corps" autocomplete="libelle" autofocus required>
