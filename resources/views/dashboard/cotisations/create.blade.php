@extends('layouts.dashboard', ['title' => 'Ajout d\'une cotisation', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Cotisation'])
        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body" id="show_create">
                    <h6 class="fw-bold">Informations de la cotisation</h6>
                    <form action="{{ route('cotisations.store') }}" method="POST" id="add_direction_form"
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="form-floating">
                                    <input type="number" id="montant_a_payer" name="montant_a_payer"
                                        ...
                                        value="{{ old('montant_a_payer') }}" placeholder="montant " autocomplete="montant_a_payer"
                                        autofocus required>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-floating">
                                    <input type="date" id="date_debut" name="date_debut"
                                        ...
                                        value="{{ old('date_debut') }}"  autocomplete="date_debut"
                                        autofocus required>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-floating">
                                    <input type="date" id="date_fin" name="date_fin"
                                        ...
                                        value="{{ old('date_fin') }}"  autocomplete="date_fin"
                                        autofocus required>
