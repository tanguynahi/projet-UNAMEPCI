@extends('layouts.dashboard', ['title' => 'Ajout d\'un type de pièce', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Type-Pièce'])
    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body" id="show_create">
                <h6 class="fw-bold">Informations du type de pièce</h6>
                <form action="{{ route('typepieces.store') }}" method="POST" id="add_type_piece_form" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
