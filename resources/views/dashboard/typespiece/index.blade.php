@extends('layouts.dashboard', ['title' => 'Liste des types de pièce', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Types de pièce'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Liste des types de pièce</h6>
                    <div class="dropdown morphing scale-left">
                        <a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full-Screen"><i
                                class="icon-size-fullscreen"></i></a>
                        @can('ajouter-typePieces')
                ...
                <div class="card-body" id="show_all_types_piece">
                    <div class="table-responsive">
                        <table id="myTable" class="table myDataTable table-hover align-middle mb-0 card-table">
                            ...
                            <tbody>
                                @foreach ($typepieces as $index => $typepiece)
                                    @php
                                        $statusBadge =
                                            $typepiece->status == 1
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: pre-line;">{{ $typepiece->description }}</td>

                                        <td>{!! $statusBadge !!}</td>
                                        <td>

                                            @if ($typepiece->status == 2)
                                                <a href="#deleteModal{{ $typepiece->id }}" id="RestaurerTypePiece"
                                            ...
                                            @else
                                                {{-- <a href="{{ route('typepieces.show', $typepiece->id) }}" id="ShowTypePiece"
                                                ...
                                                @can('modifier-typePieces')
                                                    <a href="{{ route('typepieces.edit', $typepiece->id) }}" id="EditTypePiece"
                                                ...
                                                <div class="modal-body p-5 text-center">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        ...
                                                        <div class="hstack gap-2 justify-content-center remove">
                                                            ...
                                                            @else
                                                                <form method="POST"
                                                                    action="{{ route('typepieces.destroy', $typepiece->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
