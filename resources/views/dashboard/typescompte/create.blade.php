@extends('layouts.dashboard', ['title' => 'Ajout d\'un type de compte', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Type-Compte'])
    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body" id="show_create">
                <h6 class="fw-bold">Informations du type de compte</h6>
                <form action="{{ route('typecomptes.store') }}" method="POST" id="add_type_compte_form" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating">
                                <input type="text" id="libelle" name="libelle" class="form-control @error('libelle') is-invalid @enderror" value="{{ old('libelle') }}" placeholder="Type de compte" autocomplete="libelle" autofocus required>
