                ...
                <div class="table-responsive">
                    <table id="myTable" class="table myDataTable table-hover align-middle mb-0 card-table">
                        ...
                        <tbody>
                            ...
                            @php
                            $imgUrl = $administrateur->lien_photo ? asset($administrateur->lien_photo) : asset('assets/dashboard/img/default-img.png');
                            $statusBadge = $administrateur->status == 1 ? '<span class="badge bg-success"> Compte Actif </span>' : '<span class="badge bg-danger"> Compte Inactif </span>';
                            $isOnline = $administrateur->disponibilite == "En ligne" ? '<span class="badge bg-success"> En ligne </span>' : '<span class="badge bg-danger"> Hors Ligne </span>';
                            @endphp
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <img src="{{ $imgUrl }}" class="avatar sm rounded me-2" alt="profile-image">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('administrateurs.edit',$administrateur->id) }}" id="EditAdmin" class="btn btn-link btn-sm text-primary editIcon" data-bs-target="#edit_admin" title="Modifier"><i class="fa fa-pencil"></i></a>
                                    <a href="#deleteModal{{ $administrateur->id }}" id="DeleteAdministrateur" class="btn btn-link btn-sm text-danger deleteIcon" data-bs-toggle="modal" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimer"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>

                            <!-- Modal delete-->
                            <div class="modal fade flip" id="deleteModal{{ $administrateur->id }}" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <p class="text-muted fs-15 mb-4">En supprimant cet administrateur, vous supprimez
                                                    <br> toutes les informations le concernant de notre base de données.
                                                </p>
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    <button class="btn btn-link link-success fw-medium text-decoration-none" id="deleteRecord-close" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Fermer</button>
