                    ...
                    <div class="info-section mt-3">
                        ...
                        <div class="row">
                            ...
                            @if ($inscription->photo_identite_1)
                                <div class="col-md-3 col-sm-6 info-item">
                                    <span class="info-label">Photo identité:</span><br>
                        ...
                        <form action="{{ route('inscriptions.approuver', $inscription->id) }}" method="POST"
                            ...
                            <div class="card border-success">
                                <div class="card-header bg-success text-white">
                                    <h6 class="mb-0">Confirmation d'approbation</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="commentaire_approbation" class="form-label">Commentaire
                                            (optionnel)</label>
                                        <textarea name="commentaire_approbation" id="commentaire_approbation"
                                            class="form-control @error('commentaire_approbation') is-invalid @enderror" rows="3"
                                            placeholder="Vous pouvez ajouter un commentaire...">{{ old('commentaire_approbation') }}</textarea>
                                        @error('commentaire_approbation')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <button type="button" id="btn_annuler_approbation"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn_rejeter').click(function() {
                $('#rejeter_inscription_form').slideDown();
                $('#approuver_inscription_form').slideUp();
            });

            $('#btn_approuver').click(function() {
                $('#approuver_inscription_form').slideDown();
            ...
            $('#btn_annuler_approbation').click(function() {
                $('#approuver_inscription_form').slideUp();
            });
            ...
            $('#approuver_inscription_form').submit(function(e) {
