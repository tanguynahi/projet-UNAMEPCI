@extends('layouts.dashboard', ['title' => 'Ajout d\'une actualité', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Actualité'])
    ...
    <div class="col-10">
        <div class="card">
            ...
            <div class="card-body" id="show_create">
                ...
                <form action="{{ route('actualite.store') }}" method="POST" id="add_actualite_form" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-4 col-md-4">
                            <div class="form-floating">
                                <input  type="file" id="lien_photo" name="lien_photo" class="form-control @error('lien_photo') is-invalid @enderror" value="{{ old('lien_photo') }}" placeholder="Photo" autocomplete="lien_photo" autofocus required>
                        ...
                        <div class="col-lg-5 col-md-5">
                            <div class="form-floating">
                                <input type="text" id="libelle" name="libelle" class="form-control @error('libelle') is-invalid @enderror" value="{{ old('libelle') }}" placeholder="Actualité" autocomplete="libelle" autofocus required>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="form-floating">
                                <input type="date" id="date_actualite" name="date_actualite" class="form-control @error('date_actualite') is-invalid @enderror" value="{{ old('date_actualite') }}" placeholder="Date actualité" autocomplete="date_actualite" autofocus required>
