@extends('layouts.dashboard', ['title' => 'Modifier un projet', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Modifier-Projet'])
        ...
        <div class="col-10">
            <div class="card">
                ...
                <div class="card-body" id="show_create">
                    ...
                    @if ($projet->lien_photo)
                        <div class="row g-3 mb-3 justify-content-start align-content-center">
                            <div class="col-lg-4 col-md-4">
                                <img src="{{ asset($projet->lien_photo) }}" alt="Images du projet"
                                    class="img-thumbnail mt-3" width="60" height="50">
                                <span class="text-primary fw-bold">Image du projet</span>
                            </div>
                        </div>
                    @endif
                    <form action="{{ route('projets.update', $projet->id) }}" method="POST" id="edit_projet_form"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-floating">
                                    <input type="text" id="libelle" name="libelle"
                                        ...
                                        value="{{ old('libelle', $projet->libelle) }}" placeholder="Actualité"
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-floating">
                                    <input type="file" id="lien_photo" name="lien_photo"
                                        ...
                                        accept=".jpeg, .jpg, .png" placeholder="Image principale du projet"
                                        autocomplete="lien_photo" autofocus>
                                    <label for="lien_photo">Image principale du projet<span
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <textarea id="summernote" name="description" class="form-control no-resize @error('description') is-invalid @enderror"
                                    autocomplete="description" autofocus required>{{ old('description', $projet->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-floating">
                                    <input type="file" id="lien_image" name="lien_image[]" multiple
                                        ...
                                        accept=".jpeg, .jpg, .png" placeholder="Images du projet" autocomplete="lien_image"
                                        autofocus>
                                    <label for="lien_image">Images du projet<span
                                            class="text-danger fw-bold"></span></label>
                                    @error('lien_image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                @foreach ($projet->imagesProjet as $imageProjet)
                                    <div class="col-lg-3 col-md-3">
                                        <img src="{{ asset($imageProjet->lien_image) }}"
                                            alt="Image du projet {{ $loop->iteration }}" class="img-thumbnail mt-3"
                                            width="80" height="90">
                                    </div>
                                @endforeach
                            @endif
