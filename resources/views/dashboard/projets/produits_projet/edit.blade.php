                    ...
                    <form action="{{ route('produitprojets.update', $produitprojet->id) }}" method="POST"
                            ...
                            <div class="col-lg-2 col-md-2">
                                <div class="form-floating">
                                    <input type="number" id="quantite" name="quantite"
                                        ...
                                        value="{{ old('quantite', $produitprojet->quantite) }}" placeholder="Pièce"
                                        autocomplete="quantite" autofocus>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="row justify-content-center">
                                @if ($produitprojet->imageProjets->count() > 0)
                        ...
                        <div class="row g-3 ">
                            <div class="mx-auto d-flex justify-content-center">
                                ...
                                <a href="{{ route('produitprojets.index', ['projet_id' => $produitprojet->projet_id]) }}" class="btn btn-secondary w-25 mx-2">Annuler</a>
