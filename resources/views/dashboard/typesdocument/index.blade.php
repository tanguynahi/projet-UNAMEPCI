@extends('layouts.dashboard', ['title' => 'Liste des types de document', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Types de document'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Liste des types de document</h6>
                ...
                <div class="card-body" id="show_all_types_paiement">
                    <div class="table-responsive">
                        <table id="myTable" class="table myDataTable table-hover align-middle mb-0 card-table">
                            ...
                            <tbody>
                                @foreach ($typedocuments as $index => $typedocument)
                                    @php
                                        $statusBadge =
                                            $typedocument->status == 1
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: pre-line;">{{ $typedocument->description }}</td>

                                        <td>{!! $statusBadge !!}</td>
                                        <td>

                                            @if ($typedocument->status == 2)
                                                <a href="#deleteModal{{ $typedocument->id }}" id="RestaurerTypeDocument"
                                            ...
                                            @else
                                                {{-- <a href="{{ route('typedocuments.show', $typedocument->id) }}"
                                                    id="ShowTypeDocument" class="btn btn-link btn-sm text-success infoIcon"
                                    ...
                                    <!-- Modal delete-->
                                    <div class="modal fade flip" id="deleteModal{{ $typedocument->id }}" tabindex="-1"
                                        aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body p-5 text-center">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        @if ($typedocument->status == 2)
                                                            <h4>Vous êtes sur le point de restaurer <br>un type de document
                                                                ?</h4>
                                                        ...
                                                        @else
                                                            <h4>Vous êtes sur le point de supprimer <br>un type de document
                                                                ?</h4>
                                                        ...
                                                        <div class="hstack gap-2 justify-content-center remove">
                                                            ...
                                                            @if ($typedocument->status == 2)
                                                                <form method="POST"
                                                                    action="{{ route('typedocument.restaure', $typedocument->id) }}">
                                                                    @method('PUT')
                                                                    @csrf
                                                            ...
                                                            @else
                                                                <form method="POST"
                                                                    action="{{ route('typedocuments.destroy', $typedocument->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
