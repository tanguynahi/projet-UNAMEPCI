redevances@extends('layouts.dashboard', ['title' => 'Ajout d\'une ville', 'toolbar' => '_toolbar2', 'breadcrumb' => 'Ajouter-Ville'])
    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body" id="show_create">
                ...
                <form action="{{ route('villes.store') }}" method="POST" id="add_admin_form" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating">
                                <input type="text" id="libelle" name="libelle" class="form-control @error('libelle') is-invalid @enderror" value="{{ old('libelle') }}" placeholder="Ville" autocomplete="libelle" autofocus required>
