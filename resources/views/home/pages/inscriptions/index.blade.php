                ...
                <div class="col-md-9">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check-card">
                                            <input class="form-check-input" type="radio" name="typeAdhesion"
                                                ...
                                                {{ old('typeAdhesion') == 'revision' ? 'checked' : '' }}>
                                    ...
                                    {{-- <div class="col-md-4 mb-3">
                                        <div class="form-check-card">
                                            <input class="form-check-input" type="radio" name="typeAdhesion"
                                                ...
                                                {{ old('typeAdhesion') == 'modification' ? 'checked' : '' }}>
                                            <label class="form-check-label w-100 h-100" for="typeAdhesion_modification">
                                                <div class="card border border-light h-100">
                                                    <div class="card-body text-center">
                                                        <i class="feather-edit fs-2 mb-2 text-muted"></i>
                                                        <h6 class="card-title">Modification</h6>
                                                        <p class="card-text small text-muted">Changement de statut</p>
                                                    </div>
                                                </div>
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="rbt-modern-select bg-transparent height-45">
                                    <select
                                        ...
                                        <option value="">Sélectionnez...</option>
                                        {{-- <option value="Salarié" {{ old('statut_emploi') == 'Salarié' ? 'selected' : '' }}>
                                            Salarié</option>
                                        <option value="Indépendant"
                                            {{ old('statut_emploi') == 'Indépendant' ? 'selected' : '' }}>Indépendant
                                        </option>
                                        <option value="Fonctionnaire"
                                            {{ old('statut_emploi') == 'Fonctionnaire' ? 'selected' : '' }}>Fonctionnaire
                                        </option>
                                        <option value="Retraité"
                                            {{ old('statut_emploi') == 'Retraité' ? 'selected' : '' }}>
                                            Retraité</option>
                                        <option value="En recherche"
                                            {{ old('statut_emploi') == 'En recherche' ? 'selected' : '' }}>En recherche
                                        </option> --}}
                            ...
                            {{-- <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="montant_cotis_annuel" name="montant_cotis_annuel"
                                        value="{{ old('montant_cotis_annuel') }}"
                                        class="form-control form-control-custom @error('montant_cotis_annuel') is-invalid @enderror"
                                        min="0" placeholder="Montant">
                    ...
                    <div class="form-section conditional-hidden" id="section-documents">
                        ...
                        <div class="row g-3">
                            ...
                            {{-- <div class="col-md-6">
                                <label for="photo_identite_2" class="form-label">Photo d'identité supplémentaire 2</label>
                                <div class="document-upload" id="photoIdentite2Upload">
                                    <input type="file" name="photo_identite_2" id="photo_identite_2"
                                        class="@error('photo_identite_2') is-invalid @enderror">
                                    <div class="upload-content">
                                        <i class="feather-upload fs-4 mb-2"></i>
                                        <p class="mb-1 upload-text">Cliquez pour télécharger</p>
                                        <small class="text-muted">Format: JPEG, PNG (max 2MB)</small>
