@extends('layouts.home', ['title' => 'Actualites'])
@push('css')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ul class="page-list">
                                    ...
                                    <li class="rbt-breadcrumb-item active">Actualité</li>
                                </ul>
                                <!-- End Breadcrumb Area  -->
                                <div class=" title-wrapper">
                                    <h1 class="title mb--0">Actualites</h1>
                                    <a href="#" class="rbt-badge-2">
                                        <div class="image">🎉</div> {{ $actualites->count() }}
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body text-center">
                                <ul class="rbt-meta">
                                    <li class="h3">
                                        <i class="feather-clock"></i>{{ formatDate($actualite->date_actualite) }}
                                    </li>
                                </ul>
                                <h4 class="rbt-card-title"><a
                                        href="{{ route('detail.actualites', $actualite->id) }}">{{ $actualite->libelle }}</a>
                                </h4>
                                <div class="read-more-btn">
                                    <a class="rbt-btn btn-border hover-icon-reverse btn-sm radius-round"
                                        href="{{ route('detail.actualites', $actualite->id) }}">
