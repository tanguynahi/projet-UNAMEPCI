...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="rbt-modern-select bg-transparent height-45">
                                    <select
                                        ...
                                        name="situation_matrimoniale" id="situation_matrimoniale" required>
                                        <option value="">Sélectionnez...</option>
                                        <option value="Célibataire" {{ old('situation_matrimoniale', $mutualiste->situation_matrimoniale) == 'Célibataire' ? 'selected' : '' }}>Célibataire</option>
                                        <option value="Marié(e)" {{ old('situation_matrimoniale', $mutualiste->situation_matrimoniale) == 'Marié(e)' ? 'selected' : '' }}>Marié(e)</option>
                                        <option value="Divorcé(e)" {{ old('situation_matrimoniale', $mutualiste->situation_matrimoniale) == 'Divorcé(e)' ? 'selected' : '' }}>Divorcé(e)</option>
                                        <option value="Veuf/Veuve" {{ old('situation_matrimoniale', $mutualiste->situation_matrimoniale) == 'Veuf/Veuve' ? 'selected' : '' }}>Veuf/Veuve</option>
                                    </select>
                                </div>
                                @error('situation_matrimoniale')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="form-section conditional-hidden" id="section-freelance">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="raison_social_secondaire_freelance" class="form-label">Raison sociale freelance</label>
                                <input type="text" id="raison_social_secondaire_freelance" name="raison_social_secondaire_freelance"
                                    value="{{ old('raison_social_secondaire_freelance', $mutualiste->raison_social_secondaire_freelance) }}"
                                    class="form-control form-control-custom @error('raison_social_secondaire_freelance') is-invalid @enderror"
                                    placeholder="Raison sociale freelance">
                                @error('raison_social_secondaire_freelance')
                            ...
                            <div class="col-md-6">
                                <label for="fonction_occupe_freelance" class="form-label">Fonction occupée (freelance)</label>
                                <input type="text" id="fonction_occupe_freelance" name="fonction_occupe_freelance"
                                    value="{{ old('fonction_occupe_freelance', $mutualiste->fonction_occupe_freelance) }}"
                                    class="form-control form-control-custom @error('fonction_occupe_freelance') is-invalid @enderror"
                                    placeholder="Fonction freelance">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="rbt-modern-select bg-transparent height-45">
                                    <select
                                        ...
                                        name="type_contrat_freelance" id="type_contrat_freelance">
                                        <option value="">Sélectionnez...</option>
                                        <option value="CDI" {{ old('type_contrat_freelance', $mutualiste->type_contrat_freelance) == 'CDI' ? 'selected' : '' }}>CDI</option>
                                        <option value="CDD" {{ old('type_contrat_freelance', $mutualiste->type_contrat_freelance) == 'CDD' ? 'selected' : '' }}>CDD</option>
                                        <option value="Prestation" {{ old('type_contrat_freelance', $mutualiste->type_contrat_freelance) == 'Prestation' ? 'selected' : '' }}>Prestation</option>
                                        <option value="Consultant" {{ old('type_contrat_freelance', $mutualiste->type_contrat_freelance) == 'Consultant' ? 'selected' : '' }}>Consultant</option>
                                        <option value="Autre" {{ old('type_contrat_freelance', $mutualiste->type_contrat_freelance) == 'Autre' ? 'selected' : '' }}>Autre</option>
                                    </select>
                                </div>
                                @error('type_contrat_freelance')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <label for="adresse_postale_freelance" class="form-label">Adresse postale freelance</label>
                                <input type="text" id="adresse_postale_freelance" name="adresse_postale_freelance"
                                    value="{{ old('adresse_postale_freelance', $mutualiste->adresse_postale_freelance) }}"
                                    class="form-control form-control-custom @error('adresse_postale_freelance') is-invalid @enderror"
                                    placeholder="Adresse postale freelance">
                            ...
                            <div class="col-md-6">
                                <label for="domaine_activite_freelance" class="form-label">Domaine d'activité (freelance)</label>
                                <input type="text" id="domaine_activite_freelance" name="domaine_activite_freelance"
                                    value="{{ old('domaine_activite_freelance', $mutualiste->domaine_activite_freelance) }}"
                                    class="form-control form-control-custom @error('domaine_activite_freelance') is-invalid @enderror"
                                    placeholder="Domaine d'activité freelance">
                    ...
                    <div class="form-section conditional-hidden" id="section-relations">
                        ...
                        <div id="questionAuteurSection">
                            ...
                            <div class="conditional-field p-3 mb-3 conditional-hidden" id="auteurTiersSection">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="etre_auteur" id="auteur_tiers_oui" value="1"
                                        {{ old('etre_auteur', $mutualiste->etre_auteur) == 1 && old('relation_tiers', $mutualiste->relation_tiers) == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="auteur_tiers_oui">
                                        C'est le tiers mentionné ci-dessus
                                    </label>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="etre_auteur" id="auteur_tiers_non" value="0"
                                        {{ old('etre_auteur', $mutualiste->etre_auteur) == 0 && old('relation_tiers', $mutualiste->relation_tiers) == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="auteur_tiers_non">
                                        C'est une autre personne
                                    </label>
    ...
    <div id="loaderOverlay" class="loader-overlay hidden">
        <div class="loader-content">
            ...
            <div class="loader-subtext">Veuillez patienter, nous mettons à jour votre profil...</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateButtons() {
                ...
                if (currentSection === sections.length - 1) {
                    $('#nextSection').html('Mettre à jour le profil <i class="feather-check-circle ms-2"></i>');
