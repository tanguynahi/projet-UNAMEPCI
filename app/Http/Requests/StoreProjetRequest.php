...
class StoreProjetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'libelle' => 'required|string|min:3|unique:projets,libelle',
    ...
    {
        return [
            'lien_photo.required' => 'La photo du projet est obligatoire.',
            ...
            'libelle.unique' => 'Ce projet existe déjà dans notre système.',
            ...
            // 'lien_image.image'=> "Veuillez choisir des images.",
            // 'lien_image.mimes'=> "Format de fichier nom pris en charge, veuillez choisir des images (jpg,jpeg,png)",
            // 'lien_image.uploaded'=> "Taille d'image choisie trop grande, veuillez choisir des images (poids <= 2mo).",
        ];
    }
}
