...
class StoreDemandeProduitRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'lien_document' => 'required|image|mimes:jpg,jpeg,png,pdf',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'lien_document.required' => 'le document est requis',
             'lien_document.image'=> "Veuillez choisir un document de type image ou pdf.",
             'lien_document.mimes'=> "Format de fichier nom pris en charge, veuillez choisir une image (jpg,jpeg,png)",
            //  'lien_document.uploaded'=> "Taille de l'image choisie trop grande, veuillez choisir une autre image (poids <= 2mo).",
        ];
    }
}
