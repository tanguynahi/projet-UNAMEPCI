...
class StoreProduitProjetRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'lien_photo.required' => 'La photo du produit est obligatoire.',
            ...
            // 'quantite.required' => 'Le nbre de pièces du produit  est obligatoire.',
            'quantite.integer' => 'Le quantité du produit  doit être un nombre entier.',
            ...
            'projet_id.required' => 'l\'id du projet est requis',
            'projet_id.integer' => 'l\'id du projet doit etre de type entier',
            'projet_id.exists' => 'l\'id du projet introuvable.',
        ];
    }
}
