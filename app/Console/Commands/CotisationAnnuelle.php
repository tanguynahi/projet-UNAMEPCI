...
class CotisationAnnuelle extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cotisation:annuelle';
     ...
     * @var string
     */
    protected $description = 'Generer automatiquement une cotisation annuelle pour les mutualistes';
    ...
    {
        //
        // Obtenir tous les mutualistes avec fréquence de paiement Annuelle
        $mutualistes = CotisationMutualiste::where('frequence_paiement', 'Annuelle')
            ->whereIn('status', [1, 2])
        ...
        $cotisations = CotisationMutualiste::where('frequence_paiement', 'Journalière')
        ...
        foreach ($cotisations as $cotisation) {
          ...
          $facturations = Facturation::where('periode_id', 5)
          ->whereIn('status', [1, 3])
      ...
      foreach ($facturations as $facturation) {
        ...
        $this->info('Cotisations Annuelles générées avec succès.');
    }
}
